...
<html>
	<head>
		...
		<!--META TAGs-->
		<meta name="Description" CONTENT="師大學生會權益部公告最新消息的頁面，權益部會要求校方資訊透明化，中止長久以來行政單位與學生之間的資訊不對等。"> <!-- 描述 -->
		<meta name="KeyWords" content="師大學生會,NTNUSA,權益部">  <!-- 關鍵字, 協助SEO -->
...
.content{
	...
	<center>
		...
		<div class="BBODY">
			<div class="content">
				<?php include'html/department/right/right.html' ?>
			</div>
		</div>
