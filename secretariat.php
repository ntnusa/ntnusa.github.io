...
<html>
	<head>
		...
		<!--META TAGs-->
		<meta name="Description" CONTENT="師大學生會秘書處公布最新消息的頁面，秘書部是學生會對學校的聯絡管道之一，協助會長與副會長推行各項業務。"> <!-- 描述 -->
		<meta name="KeyWords" content="師大學生會,NTNUSA,秘書部">  <!-- 關鍵字, 協助SEO -->
...
.content{
	...
	<center>
		...
		<div class="BBODY">
			<div class="content">
				<?php include'html/department/secretariat/secretariat.html' ?>
			</div>
		</div>
