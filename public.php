...
<html>
	<head>
		...
		<!--META TAGs-->
		<meta name="Description" CONTENT="師大學生會公關部公布最新消息的頁面，負責本會內外聯絡協調事宜。贊助爭取、資源尋覓、對外關係扮演各學生會活動的靠山。"> <!-- 描述 -->
		<meta name="KeyWords" content="師大學生會,NTNUSA,公關部">  <!-- 關鍵字, 協助SEO -->
...
.content{
	...
	<center>
		...
		<div class="BBODY">
			<div class="content">
				<?php include'html/department/public/public.html' ?>
			</div>
		</div>
