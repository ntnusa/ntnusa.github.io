...
<html>
	<head>
		...
		<!--META TAGs-->
		<meta name="Description" CONTENT="師大學生會會長及副會長公布最新消息的頁面。"> <!-- 描述 -->
		<meta name="KeyWords" content="師大學生會,NTNUSA,會長">  <!-- 關鍵字, 協助SEO -->
...
.content{
	...
	<center>
		...
		<div class="BBODY">
			<div class="content">
				<?php include'html/department/president/president.html' ?>
			</div>
		</div>
